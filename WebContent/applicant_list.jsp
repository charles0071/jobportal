...
<tr>
<td width="150"><%@ include file="/hrms_main_menu.jsp" %></td>  
...
%>
	...
	if ( ApplicantList != null && ApplicantList.size() > 0 ){
		...
		<form name="form1" method="post">
			...
			<a href='http://localhost:4040/jobportal/applicant_test_dtl?dbopr=call&&applicant_id=<%=applicantDBObj.applicant_id%>' class=yellowlink>Select</a>
			</td >
			<td align='center' bgcolor="#843F8B">
			<a href='http://localhost:4040/jobportal/hrms_applicant?dbopr=detail&&applicant_id=<%=applicantDBObj.applicant_id%>' class=yellowlink>Detail </a>
			</td >
			<%
			}
			else{
			%>
			<td align='center' bgcolor="#843F8B">
			<a href='http://localhost:4040/jobportal/hrms_applicant?dbopr=edit&&applicant_id=<%=applicantDBObj.applicant_id%>' class="yellowlink">Edit </a>
			</td >
			<td align='center' bgcolor="#843F8B">
			<a href='http://localhost:4040/jobportal/hrms_applicant?dbopr=delete&&applicant_id=<%=applicantDBObj.applicant_id%>' class="yellowlink">Delete </a>
			</td >
			<td align='center' bgcolor="#843F8B">
			<a href='http://localhost:4040/jobportal/hrms_applicant?dbopr=detail&&applicant_id=<%=applicantDBObj.applicant_id%>' class="yellowlink">Detail </a>
			</td >
